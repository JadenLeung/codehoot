const config = {
    ...
    qdata: [
        { time: 100, name: "char_limit", testcases: 4 },
        { time: 300, name: "starts_with", testcases: 8 },
        { time: 600, name: "space_check", testcases: 5 },
        { time: 600, name: "initialized", testcases: 4 },
        { time: 800, name: "least_letter", testcases: 7 },
        { time: 900, name: "linalg", testcases: 7 },
        { time: 1200, name: "countones", testcases: 10 },
        // { time: 600, name: "limited_calculator", testcases: 8 },
        // { time: 150, name: "linked_sum", testcases: 6 },
        // { time: 500, name: "linked_middle", testcases: 7 },
        // { time: 500, name: "bsearch", testcases: 5 },
        // { time: 500, name: "bst_height", testcases: 6 },
        // { time: 500, name: "is_bst", testcases: 9 },
    ],
