const config = {
    ...
    qdata: {
        Q1: { time: 600, name: "linalg", testcases: 7 },
        Q2: { time: 150, name: "linked_sum", testcases: 6 },
        Q3: { time: 500, name: "linked_middle", testcases: 7 },
        Q4: { time: 500, name: "bsearch", testcases: 5 },
        Q5: { time: 500, name: "bst_height", testcases: 6 },
        Q6: { time: 500, name: "is_bst", testcases: 9 },
        Q7: { time: 800, name: "least_letter", testcases: 7 },
        Q8: { time: 600, name: "limited_calculator", testcases: 8 },
    },
